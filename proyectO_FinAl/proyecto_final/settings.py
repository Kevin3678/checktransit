...
SECRET_KEY = 'django-insecure-h3x$((8-ztkm$s(hqa)&5j!t^i93v8h-7m(^-#9h3#chdkaskz'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'checktransit@gmail.com'
EMAIL_HOST_PASSWORD = 'gefipmgfyebuxigy'  # contraseña de aplicación
